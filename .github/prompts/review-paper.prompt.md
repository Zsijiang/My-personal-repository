...
1. **Locate and read the manuscript** from the given path or `master_supporting_docs/`

2. **Read the full paper** end-to-end. For long papers, read section by section.
...
- **Think like a top-5 journal referee.** What would make them reject?
