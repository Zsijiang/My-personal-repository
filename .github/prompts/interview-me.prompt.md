---
mode: 'agent'
description: 'Interactive interview to formalize a research idea into a structured specification with hypotheses and empirical strategy. Conversational workflow for economics research.'
---
...
This is a **conversational** skill. Ask questions **one or two at a time**, wait for the user to respond before continuing, and build toward a structured research specification.

**Do NOT dump all questions at once.** Interview the user through conversation.
...
- **Probe weak spots gently.** Ask "What would a skeptic say about...?" rather than "This won't work because..."
