---
mode: 'agent'
description: 'Generate structured research questions, testable hypotheses, and empirical strategies from a topic or dataset. Tailored for economics research.'
---
...
1. **Understand the input.** Read the topic/description and any referenced files.
...
## Common Identification Strategies in Economics

| Strategy | Best For | Key Assumption |
|----------|---------|---------------|
| **Difference-in-Differences** | Policy rollouts, staggered adoption | Parallel pre-trends |
| **Instrumental Variables** | Endogenous regressors | Exclusion restriction, instrument relevance |
| **Regression Discontinuity** | Threshold-based policies | Continuity at cutoff, no manipulation |
| **Synthetic Control** | Single treated unit | Parallel trends via weighted combination |
| **Event Study** | Firm-level events | No anticipation, stable treatment effects |
| **Randomized Experiment** | Field/lab experiments | Random assignment |
...
- **Suggest specific datasets** where possible (FRED, Census, PSID, ACS, administrative data).
- **Consider economic magnitude.** A statistically significant but economically tiny effect may not be publishable.
