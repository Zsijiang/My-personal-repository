...
```bash
cd Slides
TEXINPUTS=../Preambles:$TEXINPUTS xelatex -interaction=nonstopmode ${input}.tex
BIBINPUTS=..:$BIBINPUTS bibtex ${input}
TEXINPUTS=../Preambles:$TEXINPUTS xelatex -interaction=nonstopmode ${input}.tex
TEXINPUTS=../Preambles:$TEXINPUTS xelatex -interaction=nonstopmode ${input}.tex
```
...
```bash
cd Slides
TEXINPUTS=../Preambles:$TEXINPUTS BIBINPUTS=..:$BIBINPUTS latexmk -xelatex -interaction=nonstopmode ${input}.tex
```
